...
namespace ExcelExtensions.Providers
{
    ...
    public class Extensions : IExtensions
    {
        ...
        public KeyValuePair<string, ParseException> LogDeveloperException(string worksheetName, ImportColumn importColumn, string cellAddress, string message, string modelPropertyName)
        {
        ...
        public KeyValuePair<string, ParseException> LogNullReferenceException(string worksheetName, ImportColumn displayName, string cellAddress, string modelPropertyName)
        {
        ...
        public KeyValuePair<string, ParseException> LogCellException(string worksheetName, ImportColumn displayName, string cellAddress, string modelPropertyName)
        {
        ...
        public KeyValuePair<int, ParseException> LogCellException(string worksheetName, ImportColumn displayName, string cellAddress, int rowNumber)
        {
            ParseException parseException = LogCellExceptionParseException(worksheetName, displayName, cellAddress);
